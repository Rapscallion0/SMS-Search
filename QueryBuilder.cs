...
namespace SMS_Search
{
    ...
    public class SearchCriteria
    {
        ...
        public bool AnyMatch { get; set; } // %value%

        // For Field Mode
        public bool ShowFields { get; set; } // vs ShowRecords
...
GROUP BY
    ...
    TAB.create_date";
        ...
        {
            // Remove any existing brackets to avoid double bracketing or injection attacks via closing brackets
